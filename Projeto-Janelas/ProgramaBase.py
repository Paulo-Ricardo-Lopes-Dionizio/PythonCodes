...
menubutton.menu.add_checkbutton(label="Português", variable=var1,command=None)
menubutton.menu.add_checkbutton(label="English", variable=var2,command=None)
menubutton.menu.add_checkbutton(label="日本語", variable=var3,command=None)
